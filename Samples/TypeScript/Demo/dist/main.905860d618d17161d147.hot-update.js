...
function steppedEvaluate(points, time) {
    return points[0] ? points[0].value : 0;
}
...
function evaluateCurve(motionData, index, time) {
    ...
    var getP = motionData.points.get(segment.basePointIndex);
    return segment && getP
        ? segment.evaluate(getP, time)
        : 0;
}
