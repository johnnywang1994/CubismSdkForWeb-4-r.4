...
function evaluateCurve(motionData, index, time) {
    ...
    for (var i = curve.baseSegmentIndex; i < totalSegmentCount; ++i) {
        ...
        if (motionData.points.at(pointPosition))
            motionData.points.at(pointPosition).time > time;
        {
            target = i;
            break;
        }
