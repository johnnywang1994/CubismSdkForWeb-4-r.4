        ...
        pointPosition =
            motionData.segments.at(i).basePointIndex +
                (motionData.segments.at(i).segmentType ==
                    ...
                    ? 3
                    : 1);
        if (motionData.points.at(pointPosition) && motionData.points.at(pointPosition).time > time) {
            target = i;
            break;
        }
    }
    if (target == -1 && motionData.points.at(pointPosition)) {
